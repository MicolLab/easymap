...
def candidates_zoom():
    ...
    if interval_width == 4000000:
        ...
        while mark in range(68, wide-50):
            ...
            bbox = draw.textbbox((0, 0), str(x_tag), font=fnt2)	
            w, h = bbox[2] - bbox[0], bbox[3] - bbox[1]
...
def gene_plot(): 
    ...
    for p in intermediate_list:
        ...
        if args.my_mut == 'snp':
            ...
            msg_1 = str(p[4][3])
            msg_2 = str(p[4][4])
            bbox_1 = draw.textbbox((0, 0), msg_1, font=fnt4)
            bbox_2 = draw.textbbox((0, 0), msg_2, font=fnt4)

            w1, h1 = bbox_1[2] - bbox_1[0], bbox_1[3] - bbox_1[1]
            w2, h2 = bbox_2[2] - bbox_2[0], bbox_2[3] - bbox_2[1] 
